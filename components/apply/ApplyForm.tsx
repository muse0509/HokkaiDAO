...
function Field({
  ...
  return (
    <div>
      <label htmlFor={name} className="mb-1.5 block text-sm text-sumi">
        {label}
        {required ? (
          <span className="ml-1 text-akane" aria-hidden="true">
            *
          </span>
        ) : recommended ? (
          <span className="ml-2 font-normal text-ink-400">recommended</span>
        ) : (
          ...
          {status === "success" ? (
            ...
            >
              ...
              <FormSection label="What you'd work on">
                ...
                <Field
                  label="Have you attended builder events, residencies, or similar programs before?"
                  name="prior_events"
                  error={errors.prior_events}
                  hint="If yes, please share the name and year."
                >
                  <textarea {...inputProps("prior_events")} rows={3} placeholder="e.g. mtnDAO 2024, ETHGlobal 2023…" />
                </Field>
              </FormSection>
              ...
              <FormSection label="Anything else">
                ...
                <label className="flex items-start gap-3 text-sm text-ink-500">
                  ...
                  />
                  I&apos;m also interested in helping organize or operate ctsDAO,
                  not just attending.
                </label>
              </FormSection>
